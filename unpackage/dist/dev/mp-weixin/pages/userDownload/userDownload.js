...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getDataList = async () => {
      isLoading.value = true;
      try {
        let res = await api_apis.apiGetUserDownloadList(queryParams);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-7c862b52"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/userDownload/userDownload.js.map
